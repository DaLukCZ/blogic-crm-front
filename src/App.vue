...
// Mock přihlášeného uživatele (nahraď např. z pinia nebo z API)
const user = ref({
    name: 'Jan Novák'
})

// Funkce pro aktivní odkaz
const isActive = (path) => {
    if (path === '/contracts') {
...
<template>
    <div class="min-h-screen flex flex-col bg-gradient-to-tr from-cyan-300 via-sky-400 to-teal-500 text-gray-800">
        <!-- Navbar -->
        <nav class="bg-white/80 backdrop-blur-sm shadow-md border-b border-cyan-300">
            <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <div class="relative group cursor-pointer z-100">
                    ...
                    <div
                        ...
                        <RouterLink to="/login"
                            class="block px-4 py-2 text-sm text-red-600 hover:bg-red-100 transition duration-150">
                            Odhlásit
                        </RouterLink>
                    </div>
                </div>
